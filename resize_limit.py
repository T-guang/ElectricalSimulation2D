...
# Using new target dimensions: Width = 200, Height = 284
generate_prefab('Assets/Prefab/LimitSwitch_SelfLock_Visual.prefab', 'LimitSwitch_SelfLock_Visual', 200, 284, [
    ('11', 98.89, 288.03), 
    ('12', 239.59, 288.03), 
    ('23', 98.89, 439.53), 
    ('24', 239.59, 439.53)
...
print("Resized to 200x284 successfully.")
