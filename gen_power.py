...
terminals = [
    {'id': 'L', 'x': -27.08, 'y': -65.49},
    {'id': 'N', 'x': -8.75, 'y': -65.35},
    {'id': 'L2', 'x': 9.31, 'y': -65.49},
    {'id': 'N2', 'x': 27.64, 'y': -65.35}
]
...
RectTransform:
  ...
  m_AnchoredPosition: {{x: {t['x']}, y: {t['y']}}}
...
MonoBehaviour:
  ...
  m_OnCullStateChanged:
    m_PersistentCalls:
      m_Calls: []
  m_Sprite: {{fileID: 21300000, guid: 4f9a160637a34fb393140511c2750e96, type: 3}}
  m_Type: 0
  m_PreserveAspect: 0
  m_FillCenter: 1
  m_FillMethod: 4
...
with open('Assets/Prefab/AC_220V_Power_Visual.prefab', 'w', encoding='utf-8') as f:
    f.write(yaml)
