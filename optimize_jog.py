...
path = "Assets/Resources/Blueprints/Templates/motor_jog_control_template.json"
...
for w in data.get("wires", []):
    ...
    if start_c == "power_3p_1" and end_c == "breaker_3p_1":
        ...
        w["color"] = "#F2C71F" if start_t == "L1" else "#14A640" if start_t == "L2" else "#E74C3C"
    ...
    # Breaker to Fuse
        ...
        w["color"] = "#F2C71F" if start_t == "P1_OUT" else "#14A640" if start_t == "P2_OUT" else "#E74C3C"
    ...
    # Fuse to KM
        ...
        w["color"] = "#F2C71F" if start_t == "L1_OUT" else "#14A640" if start_t == "L2_OUT" else "#E74C3C"
    ...
    # KM to Motor
        ...
        w["color"] = "#F2C71F" if start_t == "T1" else "#14A640" if start_t == "T2" else "#E74C3C"
